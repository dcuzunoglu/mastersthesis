...
from GlobalStuff import num_of_low_freq_bins_skipped, num_of_high_freq_bins_skipped, \
    FFT_SIZE, working_directory, audio_files_4_testing_dir
from Util import create_specgram_image_of_audio_file, process_image_for_template_matching

# ================================ MAIN  =========================================
audio_files_directory = audio_files_4_testing_dir
segment_probabilities_per_file_directory = working_directory + 'TestData/SegmentProbabilitiesPerFile/'
...
# For all files in the testing file list
f = 0
