"""
This file is used for training model-A, making predictions on the test set, and writing the predictions to csv files for
submission.
...
def get_nips4b_test_data(load_training_data_):
    ...
    # If it is saved on disk, load the testing design matrix to save time
    ...
    # Save the test design matrix to save time in future runs
...
def get_training_data_and_properties(load_training_data_):
    ...
    if load_training_data_ == 0:
        ...
        num_of_train_files_, num_of_classes_, feature_ids_, num_of_file_and_segment_probs_, \
            train_ = get_nips4b_train_data()
...
def train(num_of_cv_folds_, num_of_estimators_, max_features_, min_sample_split_, load_training_data_,
    ...
    print('Cvs, MaxNumEstimators, MaxFeaturesForSplit, MinSampleSplit: , DataAugPercentage')
    print(num_of_cv_folds_, num_of_estimators_, max_features_, min_sample_split_, data_aug_percentage_)
...
data_aug_percentage_list = [0.1, 0.25, 0.5]
            ...
            for max_features in max_features_list:
                for min_sample_split in min_sample_split_list:
                    for data_aug_percentage in data_aug_percentage_list:
                        train(num_of_cv_folds, num_of_estimators, max_features, min_sample_split, load_training_data,
                              data_aug_percentage)
